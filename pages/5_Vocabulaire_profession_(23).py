...
nihongo_french_dictionary = {
    "会社員（かいしゃいん）": "employé(e) de bureau",
    "公務員（こうむいん）": "fonctionnaire",
    "駅員（えきいん）": "employé(e) de gare",
    "銀行員（ぎんこういん）": "employé(e) de banque",
    "医者（いしゃ）": "médecin",
    "看護師（かんごし）": "infirmier, infirmière",
    "教師（きょうし）": "enseignant(e)",
    "弁護士（べんごし）": "avocat(e)",
    "警察官（けいさつかん）": "policier, policière",
    "消防士（しょうぼうし）": "pompier, pompière",
    "運転手（うんてんしゅ）": "chauffeur, conductrice",
    "料理人（りょうりにん）": "cuisinier, cuisinière",
    "農家（のうか）": "agriculteur, agricultrice",
    "漁師（りょうし）": "pêcheur, pêcheuse",
    "美容師（びようし）": "coiffeur, coiffeuse",
    "建築家（けんちくか）": "architecte",
    "エンジニア": "ingénieur, ingénieure",
    "記者（きしゃ）": "journaliste",
    "作家（さっか）": "écrivain, écrivaine",
    "画家（がか）": "peintre",
    "俳優（はいゆう）": "acteur, actrice",
    "歌手（かしゅ）": "chanteur, chanteuse",
    "店員（てんいん）": "vendeur, vendeuse",
    "スポーツ選手（せんしゅ）": "athlète, sportif, sportive",
    "研究者（けんきゅうしゃ）": "chercheur, chercheuse",
    "デザイナー": "designer",
}
...
if 'remaining_quiz' not in st.session_state:
    st.session_state.remaining_quiz = 26
...
<h1 style="font-family: 'Segoe UI; text-align: center;">
    Flash cards Quiz 3  <br>  - profession -
</h1>
""", unsafe_allow_html=True)

# クイズが終了したかどうかを確認
if remaining_quiz == 0:
    st.markdown(f"<p style='font-family:Segoe UI; font-size: 22px; padding-top: 20px;'>Votre score est {score} points sur 26</p>", unsafe_allow_html=True)
