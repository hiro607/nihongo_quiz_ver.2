...
<h1 style="font-family: 'Segoe UI; text-align: center;">
    Flash cards Quiz 2  <br>  - corps -
</h1>
""", unsafe_allow_html=True)

# クイズが終了したかどうかを確認
if remaining_quiz == 0:
    st.markdown(f"<p style='font-family:Segoe UI; font-size: 22px; padding-top: 20px;'>Votre score est {score} points sur 15</p>", unsafe_allow_html=True)
