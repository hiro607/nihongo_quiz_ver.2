...
nihongo_french_dictionary = {
    "上（うえ）": "au-dessus, en haut",
    "下（した）": "en dessous, en bas",
    "右（みぎ）": "droite",
    "左（ひだり）": "gauche",
    "前（まえ）": "devant",
    "後ろ（うしろ）": "derrière",
    "中（なか）": "dedans, intérieur",
    "外（そと）": "dehors, extérieur",
    "隣（となり）": "à côté",
    "近く（ちかく）": "proche, près de",
    "遠く（とおく）": "loin",
    "周り（まわり）": "autour",
    "間（あいだ）": "entre",
}
...
if 'remaining_quiz' not in st.session_state:
    st.session_state.remaining_quiz = 13
...
<h1 style="font-family: 'Segoe UI; text-align: center;">
    Flash cards Quiz 3  <br>  - localisation -
</h1>
""", unsafe_allow_html=True)

# クイズが終了したかどうかを確認
if remaining_quiz == 0:
    st.markdown(f"<p style='font-family:Segoe UI; font-size: 22px; padding-top: 20px;'>Votre score est {score} points sur 13</p>", unsafe_allow_html=True)
