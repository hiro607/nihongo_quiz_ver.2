...
nihongo_french_dictionary = {
    "あたまが いたい": "avoir mal à la tête",
    "さむけが する": "avoir des frissons",
    "ねつが ある": "avoir de la fièvre",
    "せきが でる": "tousser",
    "つかれている": "être fatigué(e)",
    "やけどを する": "se brûler",
    "けがを する": "se blesser",
    "くしゃみが でる": "éternuer",
    "かぜを ひく": "attraper un rhume",
...
if 'remaining_quiz' not in st.session_state:
    ...
    st.session_state.unknown_words = [] #CLG
...
<h1 style="font-family: 'Segoe UI; text-align: center;">
    Flash cards Quiz 1  <br>  - maladie -
</h1>
""", unsafe_allow_html=True)

# クイズが終了したかどうかを確認
if remaining_quiz == 0:
    st.markdown(f"<p style='font-family:Segoe UI; font-size: 22px; padding-top: 20px;'>Votre score est {score} points sur 10</p>", unsafe_allow_html=True)
